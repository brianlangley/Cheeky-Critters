...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "rectangle1",
      "./assets/sprites/structures/rectangle/1.png"
    );
    this.load.image(
      "rectangle2",
      "./assets/sprites/structures/rectangle/2.png"
    );
    this.load.image(
      "rectangle3",
      "./assets/sprites/structures/rectangle/3.png"
    );
    this.load.image(
      "rectangle4",
      "./assets/sprites/structures/rectangle/4.png"
    );
